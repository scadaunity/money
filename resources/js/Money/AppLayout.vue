<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100 select-none" :class="(mode === 'dark') ? (darkClass) : (lightClas)">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            {{mode}}
                            <div class="ml-3 relative">
                              <a @click="switchMode()" class="text-gray-500 flex items-center text-sm focus:outline-none rounded ml-auto py-2 leading-none">
